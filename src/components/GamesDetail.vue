<template>
	<div class="w-full h-96 relative bg-top bg-center" :style="{backgroundImage: 'url(' + game.background_image + ')'}">

		<div class="absolute top-0 left-0 w-full h-full p-5 text-white bg-gradient-to-t from-neutral-800 to-neutral-900/[.8] flex items-end">
			<div>
				<h1
					class="font-bold text-white text-4xl">
					{{ game.name }}
				</h1>
				<p
